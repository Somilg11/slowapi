...
def serialize(
    ...
    *,
    ...
    class_exclude = set(getattr(type(value), "__slowapi_exclude__", ()))
...
def serialization_options(handler: t.Any, controller: type | None) -> dict[str, t.Any]:
    ...
    if controller is not None:
        merged.update(getattr(controller, "__slowapi_serialize__", {}) or {})
    merged.update(getattr(handler, "__slowapi_serialize__", {}) or {})
    return merged
