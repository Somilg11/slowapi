...
The choice is made from :class:`~slowfw.config.Settings`, so it is one
...
def get_logger(name: str = "slowfw") -> logging.Logger:
    """Return a namespaced logger, configuring a default handler if needed."""
    logger = logging.getLogger(name)
    root = logging.getLogger("slowfw")
