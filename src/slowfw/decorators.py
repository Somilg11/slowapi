...
CONTROLLER_ATTR = "__slowfw_controller_meta__"
ROUTE_ATTR = "__slowfw_route_meta__"
MODULE_ATTR = "__slowfw_module__"
...
def http_code(status_code: int) -> t.Callable[[t.Any], t.Any]:
    ...
    def decorator(fn: t.Any) -> t.Any:
        fn.__slowfw_status_code__ = int(status_code)
        return fn
...
def module(
    *,
    ...
    :param providers: Classes or :class:`~slowfw.di.Provider` instances.
...
def never_suspends(target: t.Any) -> t.Any:
    ...
    """
    target.__slowfw_never_suspends__ = True
    return target
